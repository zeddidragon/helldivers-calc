...
var pug_match_html=/["&<>]/;function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (catClass, categoryFull, cats, colClass, colSpan, cols, dmgType, dmgTypeClass, dmgTypeText, dps, effectDescription, effectName, effectParams, effectValue, getWeapons, hasTag, header, magDmg, nerdMode, nerdValue, overcharge, roundStart, sourceClass, sourceFull, sourceLabels, sourceOrder, tdps, totalDmg, wikiLink) {pug_html = pug_html + "\u003Cnav class=\"links\"\u003E\u003Cul\u003E\u003Cli\u003E\u003Ca href=\"\u002F\"\u003EEarth Defense Force\u003C\u002Fa\u003E\u003C\u002Fli\u003E\u003Cli class=\"nav-selected\"\u003E\u003Ca href=\"\u002Fhelldivers-2\"\u003EHelldivers 2\u003C\u002Fa\u003E\u003C\u002Fli\u003E\u003Cli\u003E|\u003C\u002Fli\u003E\u003Cli\u003E\u003Ca href=\"https:\u002F\u002Fhelldivers.wiki.gg\"\u003EHelldivers Wiki\u003C\u002Fa\u003E\u003C\u002Fli\u003E\u003Cli\u003E\u003Ca href=\"https:\u002F\u002Fhelldivers.io\u002F\"\u003Ehelldivers.io\u003C\u002Fa\u003E\u003C\u002Fli\u003E\u003C\u002Ful\u003E\u003C\u002Fnav\u003E\u003Cheader class=\"menu\"\u003E\u003Cdiv class=\"filters\"\u003E\u003Cul class=\"sources\"\u003E";
// iterate sourceOrder
;(function(){
  var $$obj = sourceOrder;
...
if (wpn.chargefactor) {
pug_html = pug_html + "\u003Cspan class=\"overcharge\" title=\"Overcharge Bonus (Damage, vs Massive, AP, Stun)\"\u003E" + (pug_escape(null == (pug_interp = `+${overcharge(wpn)}%`) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
...
pug_html = pug_html + "\u003Cspan" + (" class=\"xap\""+pug_attr("class`ap-${ap}`", true, true, false)+" title=\"Overcharged\"") + "\u003E" + (pug_escape(null == (pug_interp = ap) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
